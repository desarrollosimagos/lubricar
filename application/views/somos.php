	...
	<body>
		...
		<div class="body">
			...
			<div class="container">
				...
				<div class="row mt-xl">
					<div class="col-md-8">
						<h2 class="font-weight-semibold mb-xs">Bienvenidos a Lubricar Delivery</h2>

						<p class="lead font-weight-normal">Fundada en 2017, by John Doe, gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non mauris vitae erat consequat.</p>
							...
							<div class="counters">
								...
								<div class="col-md-12 mb-xlg">
									<div class="counter counter-primary">
										...
										<label>Servivios realizados</label>
									</div>
								</div>
								<div class="col-md-12 mb-xlg">
									<div class="counter counter-primary">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="call-to-action-content">
								<h3>El mantenimiento preventivo evita fallas mecánicas y daños prematuros en tu vehículo.</h3>

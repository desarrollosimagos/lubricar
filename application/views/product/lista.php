...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="row">
        <div class="col-lg-12">
            <a href="<?php echo base_url() ?>product/register">
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="table-responsive">
                        <table id="tab_product" class="table table-striped table-bordered table-hover dataTables-example" >
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Nombre</th>
                                ...
                                <?php foreach ($listar as $perfil) { ?>
                                    <tr style="text-align: center">
                                        ...
                                        <td>
                                         ...
                                         <td>
                                            <?php echo $perfil->description; ?>
                                        </td>
                                        <td style='text-align: center'>
                                            <a href="<?php echo base_url() ?>product/edit/<?= $perfil->id; ?>" title="Editar" style='color: #1ab394'><i class="fa fa-edit fa-2x"></i></a>
                                        </td>
                                        <td style='text-align: center'>
...
$(document).ready(function(){
    ...
    $("table#tab_product").on('click', 'a.borrar', function (e) {
        e.preventDefault();
        ...
        function(isConfirm){
            if (isConfirm) {
                ...
                $.post('<?php echo base_url(); ?>product/delete/' + id + '', function (response) {
